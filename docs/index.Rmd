...
- **[Importação de dados](#importacao)**
  ...
  - [Caminhos](#caminhos)
  - [Tibbles](#tibbles)
  - [Cheat Sheets](#cheat-sheets-importacao)
...
- **Centro-Oeste:** redução de `r round(med_mort_inf_red_reg_bras$reducao[6], 2)` p.p. (1991—2000); redução `r med_mort_inf_red_reg_bras$reducao[11]` p.p. (2000—2010)
