...
"G:/Meu Drive/Repositorio/ufsm-monitoria-curso-r/dados/pinguins.csv"
...
pinguins_delim <- read_delim("dados/pinguins.csv", delim = ",")
pinguins_delim2 <- read_delim("dados/pinguins2.csv", delim = ";")
...
pinguins_xlsx <- read_excel("dados/pinguins.xlsx")
...
dir.create("dados_saida") # criar a pasta dados-saidas
